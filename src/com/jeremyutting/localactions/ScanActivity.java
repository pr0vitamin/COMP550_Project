...
public class ScanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beacon_manager.setRangingListener(new BeaconManager.RangingListener() {
            ...
            public void onBeaconsDiscovered(Region region, final List<Beacon> beacons) {
                runOnUiThread(new Runnable() {
                    ...
                    // Update the adapter when new beacons are found
                    @Override
                    public void run() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            // Set the light poller to run every 2 seconds
    ...
    // This is called when the on/off button is pressed
    public void lightOnOff(View view) {
        new SendStateAPITask().execute();
    }
    
    // This is called when the color button is pressed
    public void changeLightColor(View view) {
        if (nearestBeacon == 0) { // No beacon is close enough
    ...
    protected void onStop() {
        // OnStop, attempt to stop performing the Ranging action
        try {
    ...
    // This is called at the end of onStart(), it starts the ranging action
    ...
    // Custom adapter for holding devices found through scanning.
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public void replaceWith(Collection<Beacon> newBeacons) {
            ...
            nearestBeacon = 0;
            // Add the new distance to the distance tracker, and calculate the nearest beacon
         ...
         * Now with more actually working, but still not really.
         * Could take the distance as a ratio of the maximum, for better results maybe?
         */
        /*
    ...
    /*
     * This class spawns a background process to send a network request to the bulb,
     * to turn it on/off. Because networking on the UI thread is naughty.
     */
    private class SendStateAPITask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            String requestData;
            // The action taken depends on the current state of the bulb
            if (lightOn) {
    ...
    private class SendColorStateAPITask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            String requestData;
            // The color set will depend on which beacon the user is currently closest to
    ...
    private class FetchAPITask extends AsyncTask<Void, Void, String> {
        ...
        /*
         * This function is called when the response has come back from the API
         * It takes the string result, converts it into JSON, and then reads the light's state.
         */
        @Override
    ...
    // Helper function for reading the inputStream
